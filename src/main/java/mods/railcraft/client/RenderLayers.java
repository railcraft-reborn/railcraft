...
class RenderLayers {
  ...
  static void register() {
    ...
    cutout(RailcraftBlocks.ABANDONED_FLEX_TRACK);
    ...
    cutout(RailcraftBlocks.ELECTRIC_FLEX_TRACK);
    ...
    cutout(RailcraftBlocks.REINFORCED_FLEX_TRACK);
    ...
    cutout(RailcraftBlocks.STRAP_IRON_FLEX_TRACK);
