...
import mods.railcraft.world.level.block.entity.signal.DualSignal;
import mods.railcraft.world.level.block.signal.AbstractSignalBlock;
import net.minecraft.client.renderer.IRenderTypeBuffer;
import net.minecraft.client.renderer.tileentity.TileEntityRendererDispatcher;
import net.minecraft.util.Direction;

public final class DualSignalRenderer<T extends AbstractSignalBlockEntity & DualSignal>
  ...
  public void render(
    ...
    matrixStack.pushPose();
    {
      ...
      SignalAspect aspect = blockEntity.getTopAspect().getDisplayAspect();
      matrixStack.pushPose();
      {
      ...
      {
        matrixStack.translate(0.0D, -0.19D, 0.0D);
        aspect = blockEntity.getBottomAspect().getDisplayAspect();
        this.renderSignalAspect(
            matrixStack, renderTypeBuffer, packedLight, packedOverlay, aspect, direction);
      }
      matrixStack.popPose();
