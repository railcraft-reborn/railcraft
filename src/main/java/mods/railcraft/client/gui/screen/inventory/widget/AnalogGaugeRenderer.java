...
public class AnalogGaugeRenderer extends WidgetRenderer<AnalogGaugeWidget> {
  ...
  @Override
  public void render(ResourceLocation widgetLocation, GuiComponent guiComponent,
                     PoseStack poseStack, int centreX, int centreY, int mouseX, int mouseY) {
    ...
    guiComponent.blit(poseStack, centreX + this.widget.ox, centreY + this.widget.oy, this.widget.ou,
        this.widget.ov, 4, 3);
  }
}
