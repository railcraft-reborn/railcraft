...
public class SteamTurbineScreen extends RailcraftMenuScreen<SteamTurbineMenu> {
  ...
  protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
    ...
    this.font.draw(poseStack, Component.translatable(Translations.Screen.STEAM_TURBINE_ROTOR), 20, 29, 0x404040);
    this.font.draw(poseStack, Component.translatable(Translations.Screen.STEAM_TURBINE_OUTPUT), 93, 24, 0x404040);
    this.font.draw(poseStack, Component.translatable(Translations.Screen.STEAM_TURBINE_USAGE), 95, 43, 0x404040);
  }
}
