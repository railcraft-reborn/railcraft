...
public class SetSeasonTrigger extends SimpleCriterionTrigger<SetSeasonTrigger.Instance> {
  ...
  public Instance createInstance(JsonObject json,
    ...
    return new SetSeasonTrigger.Instance(playerPredicate, season, cartPredicate);
  }
  ...
  public static class Instance extends AbstractCriterionTriggerInstance {
    ...
    private Instance(EntityPredicate.Composite playerPredicate, @Nullable Season season,
        MinecartPredicate predicate) {
      super(SetSeasonTrigger.ID, playerPredicate);
      this.season = season;
