...
public class SteamTurbineModule extends ChargeModule {
  ...
  public SteamTurbineModule(ModuleProvider provider, Charge network) {
    super(provider, network);
    this.rotorContainer.callback(this.provider);
