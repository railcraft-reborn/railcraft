...
import mods.railcraft.world.level.block.entity.AbstractSignalBoxBlockEntity;
import mods.railcraft.world.level.block.entity.IRedstoneEmitter;
...
public class SignalBoxBlock extends FourWayBlock {
  ...
  protected SignalBoxBlock(Supplier<? extends AbstractSignalBoxBlockEntity> blockEntityFactory,
