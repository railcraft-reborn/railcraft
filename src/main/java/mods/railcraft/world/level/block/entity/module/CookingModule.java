...
public abstract class CookingModule<R extends AbstractCookingRecipe> extends CrafterModule {
  ...
  protected CookingModule(ModuleProvider provider, int size, int inputSlot) {
    super(provider, size);
