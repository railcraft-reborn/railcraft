 ...
 */
public class ElectricFlexTrackBlock extends TrackBlock implements IChargeBlock {

  private static final Map<Charge, ChargeSpec> CHARGE_SPECS =
      ChargeSpec.make(Charge.distribution, ConnectType.TRACK, 0.01);

  public ElectricFlexTrackBlock(Supplier<? extends TrackType> trackType, Properties properties) {
