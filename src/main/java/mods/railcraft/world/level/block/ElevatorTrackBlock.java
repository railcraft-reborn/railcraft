...
public class ElevatorTrackBlock extends Block {
  ...
  public boolean getPowered(IBlockReader world, BlockPos pos) {
  ...
  public void setPlacedBy(World world, BlockPos pos, BlockState state, LivingEntity placer,
    ...
    if (powered != isPowered(world, pos, state))
      WorldPlugin.setBlockState(world, pos, state.setValue(POWERED, !powered));
  }
  ...
  public void neighborChanged(BlockState state, World worldIn, BlockPos pos, Block neighborBlock,
    ...
    if (powered != isPowered(worldIn, pos, state))
      WorldPlugin.setBlockState(worldIn, pos, state.setValue(POWERED, !powered));
  }
  ...
  // PROTECTED //
  ////////////////////////////////////////////////////////////////////////////
  protected boolean isPowered(World world, BlockPos pos, BlockState state) {
    BlockPos posUp = pos.above();
    BlockState stateUp = world.getBlockState(posUp);
    return PowerPlugin.isBlockBeingPowered(world, pos)
        || stateUp.getBlock() == this && isPowered(world, posUp, stateUp);
  }
