...
public class AdvancedItemUnloaderBlockItem extends BlockItem {

  public AdvancedItemUnloaderBlockItem(Block block, Properties properties) {
  ...
  public void appendHoverText(ItemStack stack, TooltipContext context,
    ...
    tooltipAdder.accept(Component.translatable(Translations.Tips.ITEM_UNLOADER)
