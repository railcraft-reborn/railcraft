...
public class TrainDispenserBlockItem extends BlockItem {

  public TrainDispenserBlockItem(Block block, Properties properties) {
  ...
  public void appendHoverText(ItemStack stack, TooltipContext context,
    ...
    tooltipAdder.accept(Component.translatable(Translations.Tips.TRAIN_DISPENSER)
    ...
    tooltipAdder.accept(Component.translatable(Translations.Tips.PAIR_WITH_CONTROL_TRACK)
        .withStyle(ChatFormatting.BLUE));
    tooltipAdder.accept(Component.translatable(Translations.Tips.APPLY_REDSTONE_TO_DISPENSE_TRAINS)
