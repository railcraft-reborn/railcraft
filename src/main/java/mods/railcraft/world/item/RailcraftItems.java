...
public class RailcraftItems {
  ...
  private static final DeferredRegister<Item> deferredRegister =
      DeferredRegister.create(BuiltInRegistries.ITEM, RailcraftConstants.ID);

  public static void register(IEventBus modEventBus) {
    deferredRegister.register(modEventBus);
  }

  public static Collection<? extends Supplier<? extends Item>> entries() {
  ...
  public static final Supplier<PressureBoilerTankBlockItem> LOW_PRESSURE_STEAM_BOILER_TANK =
  ...
  public static final Supplier<Item> ELECTRIC_LOCOMOTIVE =
  ...
  public static final Supplier<Item> STEAM_LOCOMOTIVE =
  ...
  public static final Supplier<Item> WHISTLE_TUNER =
  ...
  public static final Supplier<CrackedFirestoneItem> CRACKED_FIRESTONE =
  ...
  public static final Supplier<FirestoneItem> CUT_FIRESTONE =
  ...
  public static final Supplier<Item> LOCKING_TRACK_KIT =
  ...
  public static final Supplier<Item> BUFFER_STOP_TRACK_KIT =
  ...
  public static final Supplier<Item> ACTIVATOR_TRACK_KIT =
  ...
  public static final Supplier<Item> BOOSTER_TRACK_KIT =
  ...
  public static final Supplier<Item> CONTROL_TRACK_KIT =
  ...
  public static final Supplier<Item> GATED_TRACK_KIT =
  ...
  public static final Supplier<Item> DETECTOR_TRACK_KIT =
  ...
  public static final Supplier<Item> COUPLER_TRACK_KIT =
  ...
  public static final Supplier<Item> EMBARKING_TRACK_KIT =
  ...
  public static final Supplier<Item> DISEMBARKING_TRACK_KIT =
  ...
  public static final Supplier<Item> DUMPING_TRACK_KIT =
  ...
  public static final Supplier<Item> LAUNCHER_TRACK_KIT =
  ...
  public static final Supplier<Item> ONE_WAY_TRACK_KIT =
  ...
  public static final Supplier<Item> WHISTLE_TRACK_KIT =
  ...
  public static final Supplier<Item> LOCOMOTIVE_TRACK_KIT =
  ...
  public static final Supplier<Item> THROTTLE_TRACK_KIT =
  ...
  public static final Supplier<Item> ROUTING_TRACK_KIT =
  ...
  public static final Supplier<Item> COAL_COKE = deferredRegister.register("coal_coke",
      () -> new CoalCokeItem(new Item.Properties()));

  public static final Supplier<Item> STEEL_PLATE = registerBasic("steel_plate");
  public static final Supplier<Item> IRON_PLATE = registerBasic("iron_plate");
  public static final Supplier<Item> TIN_PLATE = registerBasic("tin_plate");
  public static final Supplier<Item> GOLD_PLATE = registerBasic("gold_plate");
  public static final Supplier<Item> LEAD_PLATE = registerBasic("lead_plate");
  public static final Supplier<Item> ZINC_PLATE = registerBasic("zinc_plate");
  public static final Supplier<Item> BRASS_PLATE = registerBasic("brass_plate");
  public static final Supplier<Item> INVAR_PLATE = registerBasic("invar_plate");
  public static final Supplier<Item> BRONZE_PLATE = registerBasic("bronze_plate");
  public static final Supplier<Item> COPPER_PLATE = registerBasic("copper_plate");
  public static final Supplier<Item> NICKEL_PLATE = registerBasic("nickel_plate");
  public static final Supplier<Item> SILVER_PLATE = registerBasic("silver_plate");

  public static final Supplier<Item> STEEL_INGOT = registerBasic("steel_ingot");
  public static final Supplier<Item> TIN_INGOT = registerBasic("tin_ingot");
  public static final Supplier<Item> ZINC_INGOT = registerBasic("zinc_ingot");
  public static final Supplier<Item> BRASS_INGOT = registerBasic("brass_ingot");
  public static final Supplier<Item> BRONZE_INGOT = registerBasic("bronze_ingot");
  public static final Supplier<Item> NICKEL_INGOT = registerBasic("nickel_ingot");
  public static final Supplier<Item> INVAR_INGOT = registerBasic("invar_ingot");
  public static final Supplier<Item> LEAD_INGOT = registerBasic("lead_ingot");
  public static final Supplier<Item> SILVER_INGOT = registerBasic("silver_ingot");

  public static final Supplier<Item> SALTPETER_DUST = registerBasic("saltpeter_dust");
  public static final Supplier<Item> COAL_DUST = registerBasic("coal_dust");
  public static final Supplier<Item> CHARCOAL_DUST = registerBasic("charcoal_dust");
  public static final Supplier<Item> SLAG = registerBasic("slag");
  public static final Supplier<Item> ENDER_DUST = registerBasic("ender_dust");
  public static final Supplier<Item> SULFUR_DUST = registerBasic("sulfur_dust");
  public static final Supplier<Item> OBSIDIAN_DUST = registerBasic("obsidian_dust");

  public static final Supplier<Item> STEEL_NUGGET = registerBasic("steel_nugget");
  public static final Supplier<Item> TIN_NUGGET = registerBasic("tin_nugget");
  public static final Supplier<Item> ZINC_NUGGET = registerBasic("zinc_nugget");
  public static final Supplier<Item> BRASS_NUGGET = registerBasic("brass_nugget");
  public static final Supplier<Item> BRONZE_NUGGET = registerBasic("bronze_nugget");
  public static final Supplier<Item> NICKEL_NUGGET = registerBasic("nickel_nugget");
  public static final Supplier<Item> INVAR_NUGGET = registerBasic("invar_nugget");
  public static final Supplier<Item> SILVER_NUGGET = registerBasic("silver_nugget");
  public static final Supplier<Item> LEAD_NUGGET = registerBasic("lead_nugget");

  public static final Supplier<Item> TIN_RAW = registerBasic("tin_raw");
  public static final Supplier<Item> ZINC_RAW = registerBasic("zinc_raw");
  public static final Supplier<Item> NICKEL_RAW = registerBasic("nickel_raw");
  public static final Supplier<Item> SILVER_RAW = registerBasic("silver_raw");
  public static final Supplier<Item> LEAD_RAW = registerBasic("lead_raw");

  public static final Supplier<Item> BUSHING_GEAR = registerBasic("bushing_gear");
  public static final Supplier<Item> TIN_GEAR = registerBasic("tin_gear");
  public static final Supplier<Item> GOLD_GEAR = registerBasic("gold_gear");
  public static final Supplier<Item> IRON_GEAR = registerBasic("iron_gear");
  public static final Supplier<Item> LEAD_GEAR = registerBasic("lead_gear");
  public static final Supplier<Item> ZINC_GEAR = registerBasic("zinc_gear");
  public static final Supplier<Item> BRASS_GEAR = registerBasic("brass_gear");
  public static final Supplier<Item> INVAR_GEAR = registerBasic("invar_gear");
  public static final Supplier<Item> STEEL_GEAR = registerBasic("steel_gear");
  public static final Supplier<Item> BRONZE_GEAR = registerBasic("bronze_gear");
  public static final Supplier<Item> COPPER_GEAR = registerBasic("copper_gear");
  public static final Supplier<Item> NICKEL_GEAR = registerBasic("nickel_gear");
  public static final Supplier<Item> SILVER_GEAR = registerBasic("silver_gear");

  public static final Supplier<Item> TIN_ELECTRODE = registerBasic("tin_electrode");
  public static final Supplier<Item> GOLD_ELECTRODE = registerBasic("gold_electrode");
  public static final Supplier<Item> IRON_ELECTRODE = registerBasic("iron_electrode");
  public static final Supplier<Item> LEAD_ELECTRODE = registerBasic("lead_electrode");
  public static final Supplier<Item> ZINC_ELECTRODE = registerBasic("zinc_electrode");
  public static final Supplier<Item> BRASS_ELECTRODE = registerBasic("brass_electrode");
  public static final Supplier<Item> INVAR_ELECTRODE = registerBasic("invar_electrode");
  public static final Supplier<Item> STEEL_ELECTRODE = registerBasic("steel_electrode");
  public static final Supplier<Item> BRONZE_ELECTRODE = registerBasic("bronze_electrode");
  public static final Supplier<Item> CARBON_ELECTRODE = registerBasic("carbon_electrode");
  public static final Supplier<Item> COPPER_ELECTRODE = registerBasic("copper_electrode");
  public static final Supplier<Item> NICKEL_ELECTRODE = registerBasic("nickel_electrode");
  public static final Supplier<Item> SILVER_ELECTRODE = registerBasic("silver_electrode");

  public static final Supplier<Item> CONTROLLER_CIRCUIT = registerBasic("controller_circuit");
  public static final Supplier<Item> RECEIVER_CIRCUIT = registerBasic("receiver_circuit");
  public static final Supplier<Item> SIGNAL_CIRCUIT = registerBasic("signal_circuit");
  public static final Supplier<Item> RADIO_CIRCUIT = registerBasic("radio_circuit");

  public static final Supplier<Item> WOODEN_RAIL = registerBasic("wooden_rail");
  public static final Supplier<Item> STANDARD_RAIL = registerBasic("standard_rail");
  public static final Supplier<Item> ADVANCED_RAIL = registerBasic("advanced_rail");
  public static final Supplier<Item> REINFORCED_RAIL = registerBasic("reinforced_rail");
  public static final Supplier<Item> HIGH_SPEED_RAIL = registerBasic("high_speed_rail");
  public static final Supplier<Item> ELECTRIC_RAIL = registerBasic("electric_rail");

  public static final Supplier<Item> BAG_OF_CEMENT = registerBasic("bag_of_cement");

  public static final Supplier<Item> WOODEN_TIE = registerBasic("wooden_tie");
  public static final Supplier<Item> STONE_TIE = registerBasic("stone_tie");

  public static final Supplier<Item> REBAR = registerBasic("rebar");
  public static final Supplier<Item> WOODEN_RAILBED = registerBasic("wooden_railbed");
  public static final Supplier<Item> STONE_RAILBED = registerBasic("stone_railbed");

  public static final Supplier<Item> SIGNAL_LAMP = registerBasic("signal_lamp");

  public static final Supplier<Item> CHARGE_SPOOL_LARGE = registerBasic("charge_spool_large");
  public static final Supplier<Item> CHARGE_SPOOL_MEDIUM =
      registerBasic("charge_spool_medium");
  public static final Supplier<Item> CHARGE_SPOOL_SMALL = registerBasic("charge_spool_small");

  public static final Supplier<Item> CHARGE_MOTOR = registerBasic("charge_motor");

  public static final Supplier<Item> CHARGE_COIL = registerBasic("charge_coil");

  public static final Supplier<Item> CHARGE_TERMINAL = registerBasic("charge_terminal");

  public static final Supplier<Item> WATER_TANK_SIDING =
      blockItem("water_tank_siding", RailcraftBlocks.WATER_TANK_SIDING);

  public static final Supplier<Item> QUARRIED_STONE =
      blockItem("quarried_stone", RailcraftBlocks.QUARRIED_STONE);

  public static final Supplier<Item> QUARRIED_COBBLESTONE =
      blockItem("quarried_cobblestone", RailcraftBlocks.QUARRIED_COBBLESTONE);

  public static final Supplier<Item> POLISHED_QUARRIED_STONE =
      blockItem("polished_quarried_stone", RailcraftBlocks.POLISHED_QUARRIED_STONE);

  public static final Supplier<Item> CHISELED_QUARRIED_STONE =
      blockItem("chiseled_quarried_stone", RailcraftBlocks.CHISELED_QUARRIED_STONE);

  public static final Supplier<Item> ETCHED_QUARRIED_STONE =
      blockItem("etched_quarried_stone", RailcraftBlocks.ETCHED_QUARRIED_STONE);

  public static final Supplier<Item> QUARRIED_BRICKS =
      blockItem("quarried_bricks", RailcraftBlocks.QUARRIED_BRICKS);

  public static final Supplier<Item> QUARRIED_BRICK_STAIRS =
      blockItem("quarried_brick_stairs", RailcraftBlocks.QUARRIED_BRICK_STAIRS);

  public static final Supplier<Item> QUARRIED_BRICK_SLAB =
      blockItem("quarried_brick_slab", RailcraftBlocks.QUARRIED_BRICK_SLAB);

  public static final Supplier<Item> QUARRIED_PAVER =
      blockItem("quarried_paver", RailcraftBlocks.QUARRIED_PAVER);

  public static final Supplier<Item> QUARRIED_PAVER_STAIRS =
      blockItem("quarried_paver_stairs", RailcraftBlocks.QUARRIED_PAVER_STAIRS);

  public static final Supplier<Item> QUARRIED_PAVER_SLAB =
      blockItem("quarried_paver_slab", RailcraftBlocks.QUARRIED_PAVER_SLAB);

  public static final Supplier<Item> ABYSSAL_STONE =
      blockItem("abyssal_stone", RailcraftBlocks.ABYSSAL_STONE);

  public static final Supplier<Item> ABYSSAL_COBBLESTONE =
      blockItem("abyssal_cobblestone", RailcraftBlocks.ABYSSAL_COBBLESTONE);

  public static final Supplier<Item> POLISHED_ABYSSAL_STONE =
      blockItem("polished_abyssal_stone", RailcraftBlocks.POLISHED_ABYSSAL_STONE);

  public static final Supplier<Item> CHISELED_ABYSSAL_STONE =
      blockItem("chiseled_abyssal_stone", RailcraftBlocks.CHISELED_ABYSSAL_STONE);

  public static final Supplier<Item> ETCHED_ABYSSAL_STONE =
      blockItem("etched_abyssal_stone", RailcraftBlocks.ETCHED_ABYSSAL_STONE);

  public static final Supplier<Item> ABYSSAL_BRICKS =
      blockItem("abyssal_bricks", RailcraftBlocks.ABYSSAL_BRICKS);

  public static final Supplier<Item> ABYSSAL_BRICK_STAIRS =
      blockItem("abyssal_brick_stairs", RailcraftBlocks.ABYSSAL_BRICK_STAIRS);

  public static final Supplier<Item> ABYSSAL_BRICK_SLAB =
      blockItem("abyssal_brick_slab", RailcraftBlocks.ABYSSAL_BRICK_SLAB);

  public static final Supplier<Item> ABYSSAL_PAVER =
      blockItem("abyssal_paver", RailcraftBlocks.ABYSSAL_PAVER);

  public static final Supplier<Item> ABYSSAL_PAVER_STAIRS =
      blockItem("abyssal_paver_stairs", RailcraftBlocks.ABYSSAL_PAVER_STAIRS);

  public static final Supplier<Item> ABYSSAL_PAVER_SLAB =
  ...
  public static final Supplier<Item> CREOSOTE_BUCKET =
  ...
  public static final Supplier<Item> CREOSOTE_BOTTLE =
  ...
  private static Supplier<Item> registerBasic(String name) {
    return deferredRegister.register(name, () -> new Item(new Item.Properties()));
  }

  private static Supplier<Item> blockItem(String name, Supplier<? extends Block> block) {
