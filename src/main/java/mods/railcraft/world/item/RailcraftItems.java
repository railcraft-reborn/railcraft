...
public class RailcraftItems {
  ...
  public static final RegistryObject<Item> SIGNAL_TUNER =
      ITEMS.register("signal_tuner",
          () -> new ItemSignalTuner(new Item.Properties()
              .stacksTo(1)));
  ...
  public static final RegistryObject<Item> ELECTRIC_LOCOMOTIVE =
      ITEMS.register("electric_locomotive",
          () -> new LocomotiveItem(RailcraftEntityTypes.ELECTRIC_LOCOMOTIVE,
  ...
  public static final RegistryObject<Item> TICKET =
      ITEMS.register("ticket", () -> new Item(new Item.Properties()));

  public static final RegistryObject<Item> OVERALLS =
      ITEMS.register("overalls", () -> new ArmorItem(RailcraftArmorMaterial.OVERALLS,
          EquipmentSlotType.LEGS, new Item.Properties()));
  ...
  public static final RegistryObject<Item> RAW_FIRESTONE =
      ITEMS.register("raw_firestone", () -> new ItemFirestone(new Item.Properties()));

  public static final RegistryObject<Item> CUT_FIRESTONE =
      ITEMS.register("cut_firestone", () -> new ItemFirestone(new Item.Properties()));
  ...
  public static final RegistryObject<Item> FORCE_TRACK_EMITTER =
      ITEMS.register("force_track_emitter",
          () -> new BlockItem(RailcraftBlocks.FORCE_TRACK_EMITTER.get(),
              new Item.Properties().tab(ItemGroup.TAB_TRANSPORTATION)));

  public static final RegistryObject<Item> FORCE_TRACK =
  ...
  public static final RegistryObject<Item> STRAP_IRON =
