...
public class LauncherTrackBlockItem extends BlockItem {
  ...
  public LauncherTrackBlockItem(Block block, Properties properties) {
  ...
  public void appendHoverText(ItemStack stack, TooltipContext context,
    ...
    tooltipAdder.accept(Component.translatable(Translations.Tips.LAUNCHER_TRACK)
        .withStyle(ChatFormatting.GRAY));
    tooltipAdder.accept(Component.translatable(Translations.Tips.HIT_CROWBAR_TO_CHANGE_FORCE)
