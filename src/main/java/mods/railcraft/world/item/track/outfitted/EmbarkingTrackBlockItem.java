...
public class EmbarkingTrackBlockItem extends BlockItem {
  ...
  public EmbarkingTrackBlockItem(Block block, Properties properties) {
  ...
  public void appendHoverText(ItemStack stack, TooltipContext context,
    ...
    tooltipAdder.accept(Component.translatable(Translations.Tips.EMBARKING_TRACK)
        .withStyle(ChatFormatting.GRAY));
    tooltipAdder.accept(Component.translatable(Translations.Tips.HIT_CROWBAR_TO_CHANGE_RANGE)
