...
public class BoosterTrackBlockItem extends BlockItem {
  ...
  public BoosterTrackBlockItem(Block block, Properties properties) {
  ...
  public void appendHoverText(ItemStack stack, TooltipContext context,
    ...
    tooltipAdder.accept(Component.translatable(Translations.Tips.BOOSTER_TRACK)
        .withStyle(ChatFormatting.GRAY));
    tooltipAdder.accept(Component.translatable(Translations.Tips.SLOW_UNPOWERED)
        .withStyle(ChatFormatting.GRAY));
