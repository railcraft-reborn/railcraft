...
import mods.railcraft.world.level.block.track.outfitted.PoweredTrackBlock;
 ...
 * <p/>
 * And so long as you inherit from {@link PoweredTrackBlock} all the code for updating the
