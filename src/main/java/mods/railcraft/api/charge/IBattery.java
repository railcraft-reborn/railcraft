...
public interface IBattery {
  ...
  default float room() {
    return Math.max(0.0F, getCapacity() - getCharge());
  }
   ...
   */
  default CompoundNBT readFromNBT(CompoundNBT data) {
    setCharge(data.getFloat("charge"));
    return data;
  }
   ...
   * @return The tag provided
   */
  default CompoundNBT writeToNBT(CompoundNBT data) {
    data.putFloat("charge", getCharge());
    return data;
  }
}
