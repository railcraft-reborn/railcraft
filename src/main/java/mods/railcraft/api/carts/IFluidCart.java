...
public interface IFluidCart {
  ...
  * <p/>
  * If this interface is not implemented, a default value will be inferred based on the
  * size of the tanks of the Minecart. Anything with eight or more buckets will be assumed
  * to allow passage, but only if the contained fluid matches the request.
  *
  ...
  * Even if this function returns true, there still must be a tank that accepts the
  * Fluid in question before it can be added to the cart.
  *
  * <p>If this interface is not implemented, it is assumed to be true.
  *
  ...
  * Even if this function returns true, there still must be a tank that can extract the Fluid
  * in question before it can be removed from the cart.
  *
  * <p>If this interface is not implemented, it is assumed to be true.
  *
  * @param requester the AbstractMinecartEntity that initiated the action
