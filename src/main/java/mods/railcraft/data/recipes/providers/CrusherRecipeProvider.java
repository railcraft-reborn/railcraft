...
public class CrusherRecipeProvider extends RecipeProvider {
  ...
  private static void buildVanilla(RecipeOutput recipeOutput) {
    ...
    CrusherRecipeBuilder.crush(Ingredient.of(ItemTags.STONE_BRICKS))
        .addResult(Items.COBBLESTONE, 1, 1)
        .save(recipeOutput, "tags_stone_bricks");
    ...
    CrusherRecipeBuilder.crush(Ingredient.of(Tags.Items.ORES_REDSTONE))
        ...
        .save(recipeOutput, "tags_ores_redstone");
    CrusherRecipeBuilder.crush(Ingredient.of(Tags.Items.ORES_DIAMOND))
        ...
        .save(recipeOutput, "tags_ores_diamond");
    CrusherRecipeBuilder.crush(Ingredient.of(Tags.Items.ORES_EMERALD))
        ...
        .save(recipeOutput, "tags_ores_emerald");
    CrusherRecipeBuilder.crush(Ingredient.of(Tags.Items.ORES_LAPIS))
        ...
        .save(recipeOutput, "tags_ores_lapis");
    CrusherRecipeBuilder.crush(Ingredient.of(Tags.Items.ORES_COAL))
        ...
        .save(recipeOutput, "tags_ores_coal");
    ...
    CrusherRecipeBuilder.crush(Ingredient.of(Tags.Items.ORES_QUARTZ))
        ...
        .save(recipeOutput, "tags_ores_quartz");
  ...
  private static void buildRailcraft(RecipeOutput recipeOutput) {
    ...
    CrusherRecipeBuilder.crush(Ingredient.of(RailcraftTags.Items.SULFUR_ORE))
        ...
        .save(recipeOutput, "tags_ores_sulfur");
    CrusherRecipeBuilder.crush(Ingredient.of(RailcraftTags.Items.SALTPETER_ORE))
        ...
        .save(recipeOutput, "tags_ores_saltpeter");
    ...
    CrusherRecipeBuilder.crush(Ingredient.of(RailcraftTags.Items.QUARRIED))
        ...
        .save(recipeOutput, "tags_quarried");
    ...
    CrusherRecipeBuilder.crush(Ingredient.of(RailcraftTags.Items.ABYSSAL))
        ...
        .save(recipeOutput, "tags_abyssal");
    ...
    CrusherRecipeBuilder.crush(Ingredient.of(RailcraftItems.ZINC_SILVER_BATTERY_EMPTY.get(),
        ...
        .save(recipeOutput, "battery_empty");
  }
}
