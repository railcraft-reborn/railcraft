...
public class RailcraftOreFeatures {
  ...
  public static final RegistryObject<ConfiguredFeature<?, ?>> TIN_ORE_SMALL = register(
      "tin_ore_small",
      () -> new OreConfiguration(TIN_ORE_TARGET_LIST.get(), TIN_SMALL_VEIN_DIMENSION));
  public static final RegistryObject<ConfiguredFeature<?, ?>> TIN_ORE_LARGE = register(
      "tin_ore_large",
  ...
  public static final RegistryObject<ConfiguredFeature<?, ?>> SULFUR_ORE_BURIED = register(
      "sulfur_ore_buried",
  ...
  public static final RegistryObject<ConfiguredFeature<?, ?>> NICKEL_ORE_SMALL = register(
      "nickel_ore_small",
  ...
  public static final RegistryObject<ConfiguredFeature<?, ?>> SILVER_ORE_BURIED = register(
      "silver_ore_buried",
