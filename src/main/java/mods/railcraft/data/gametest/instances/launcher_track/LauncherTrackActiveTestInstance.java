...
public class LauncherTrackActiveTestInstance extends GameTestInstance {
  ...
  public void run(GameTestHelper helper) {
    ...
    helper.succeedWhenEntityPresent(EntityType.MINECART, 22, 1, 1);
  }
  ...
  protected MutableComponent typeDescription() {
    return Component.literal("Launcher Track Active");
  }
}
