...
public final class CartUtil {
   ...
   */
  public static List<AbstractMinecart> getMinecartsAt(Level level, BlockPos pos,
      float sensitivity) {
    return getMinecartsAt(level, pos, sensitivity, AbstractMinecart.class);
  }

  public static <T extends AbstractMinecart> List<T> getMinecartsAt(Level level, BlockPos pos,
